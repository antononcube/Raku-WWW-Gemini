...
my $knownModels = Set.new(<gemini-pro gemini-1.0-pro-001 gemini-1.0-pro gemini-1.0-latest gemini-pro-vision embedding-001 aqa>);
...
my %endPointToModels =
        ...
        'generateContent' => <gemini-pro gemini-1.0-pro-001 gemini-1.0-pro gemini-1.0-latest gemini-pro-vision>,
        'generateAnswer' => <aqa>;
